...
This directory is a vinext port of the sibling [`next/`](../next) demo.

It keeps the original Next.js app intact and provides a parallel vinext version
that can be run locally on Node with:
