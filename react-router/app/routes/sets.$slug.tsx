...
import type { Route } from "./+types/sets.$slug";
...
export async function loader({ params, request }: Route.LoaderArgs) {
  ...
  const set = await db.getSetWithCards(params.slug, page, limit);
...
export default function SetDetailPage({ loaderData }: Route.ComponentProps) {
  const { set, page } = loaderData;
