...
export function meta() {
  return [
    ...
    { name: "description", content: "Buy and sell trading cards from Pokemon, Magic, Yu-Gi-Oh and more" },
  ];
}
...
export default function HomePage({ loaderData }: Route.ComponentProps) {
  const { games, trendingCards, newReleases } = loaderData;
    ...
    <div className="space-y-12">
      ...
      <section>
        <div className="flex justify-between items-center mb-6">
          ...
          <Link to="/search?sort=trending" className="text-blue-600 hover:underline">
            View All
          </Link>
        </div>
